import { BoxColliderShape, BoxShape, Camera, CapsuleColliderShape, CircleShape, Collider, Color, ConeShape, DirectLight, Entity, HemisphereShape, ParticleRenderer, PointLight, Renderer, Script, SphereColliderShape, SphereShape, SpotLight, Transform, Vector2 } from "@galacean/engine";
/**
